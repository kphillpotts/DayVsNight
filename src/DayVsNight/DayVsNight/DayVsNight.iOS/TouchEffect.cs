...
using static DayVsNight.TouchEffect;


[assembly: ResolutionGroupName("DayVsNight")]
[assembly: ExportEffect(typeof(DayVsNight.iOS.TouchEffect), "TouchEffect")]
namespace DayVsNight.iOS
{
    public class TouchEffect : PlatformEffect
    {
        ...
        protected override void OnAttached()
        {
            ...
            DayVsNight.TouchEffect effect = (DayVsNight.TouchEffect)Element.Effects.FirstOrDefault(e => e is DayVsNight.TouchEffect);
    ...
    class TouchRecognizer : UIGestureRecognizer
    {
        ...
        public TouchRecognizer(Element element, UIView view, DayVsNight.TouchEffect touchEffect)
        {
